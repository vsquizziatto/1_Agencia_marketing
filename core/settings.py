...
import os #para acceder a los archivos del servidor, ejemplo "core"
import environ
...
CORS_ORIGIN_WHITELIST = env.list('CORS_ORIGIN_WHITELIST_DEV') #VER DESPUES PORQUE NO ANDA ESTA LINEA
